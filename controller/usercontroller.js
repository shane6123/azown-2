// const db_property_residential_rent_rr= require("../model/property_residential_rent_rr")
const db_property_master=require("../model/property_master")
...
//     const propert_type = req.body.propert_type
//     const propert_add_type = req.body.propert_add_type
   
//     // if (propert_type=="Residential"){
//     //     if (propert_add_type)
//     // }
//     res.send("proper")
// }

const property_residential_rent_rr = async (req,res)=>{
    const property_id=req.body.rr_property_id
  const description=req.body.rr_detail_description

    const pro__rr_data= new db_property_residential_rent_rr({
        rr_property_id :property_id,
        rr_detail_description:description
     } )
    await pro__rr_data.save()
    const pro_master= new db_property_master({
        property_id:property_id
    })
    await pro_master.save()
    res.send(req.body)
}
module.exports ={login,property_residential_rent_rr}
